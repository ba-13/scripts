...
//////////////////////////////////////////////////////////////
#define backlight "/amdgpu_bl1"

int
main(int argc, char *argv[]) {
  static const char *default_abp = "/sys/class/backlight" backlight "/actual_brightness";
  static const char *default_mbp = "/sys/class/backlight" backlight "/max_brightness";
